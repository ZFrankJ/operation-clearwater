...
const testPoses = Object.freeze({
  ...
  roadNorth: { position: [-26, 0.08, 69], yaw: 0, pitch: -0.16 },
  roadApron: { position: [-10, 0.08, 58], yaw: 0, pitch: -0.18 },
  roadSouth: { position: [-23, 0.08, -35], yaw: 0, pitch: -0.16 },
  corpse: { position: [4.8, 0.11, 16.2], yaw: 0, pitch: -0.28 },
